...
class Monkey:
    ...
    def __init__(self, item_list, update_value_func, digit_multiple):
        ...
        self.MULTIPLE_DIGIT_LIST.append(digit_multiple)
    ...
    def take_turn(self):
        while self.item_list:
            ...
            item = int(self.update_value_func(self.item_list.pop()))
            item %= self.get_multiple()
    ...
    def get_multiple(self):
        result = 1
        for num in self.MULTIPLE_DIGIT_LIST:
            result*=num
        return result
